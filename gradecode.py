...
class GradeCode:
    ...
    def collect_and_run_tests(self, submission, test_file_path, submission_path):
        ...
        test_result = {
            ...
            "grade": (test_result_collector.successful_tests / test_result_collector.total_tests)*100
        }
    ...
    def write_to_csv(self):
        header = ["OrgDefinedId", "Testing Assignment Points Grade <Numeric MaxPoints:300 Weight:10>", "End-of-Line Indicator"]
        data = ['student_id','grade', '#']
        with open('empty.csv', 'w', encoding='UTF8', newline='') as f:
            writer = csv.writer(f)
